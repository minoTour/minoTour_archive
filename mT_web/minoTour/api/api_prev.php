...
if ($login->isUserLoggedIn() == true) {
    ...
    if ($login->isUserLoggedIn() == true) {
        ...
        $ref = "";
        $resultstore=array();
        list($runtest,$resultstore) = checkmemstore($_SESSION['focusrun'],$jobname,$ref,$memcache,$resultstore);
        #echo $runtest . "\n";
        #echo $resultstore . "\n";
        if ($runtest==1){
            //Get exp_start_time
            ...
            setmemstore($_SESSION['focusrun'],$jobname,$ref,$memcache,$resultstore);
        }
