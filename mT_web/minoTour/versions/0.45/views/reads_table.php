			...
			$('#example tbody').on('click', 'tr', function () {
					...
					$.post( "views/read_details.php?prev=1", { readname: name })
					  .done(function( data ) {
					    ...
					    if 	(ttrue == 'Y') {
						$.getJSON('jsonencode/squiggles.php?prev=1&readname='+name+'&type=template&callback=?', function(data){
						...
						if (ctrue == 'Y') {
						$.getJSON('jsonencode/squiggles.php?prev=1&readname='+name+'&type=complement&callback=?', function(data){
