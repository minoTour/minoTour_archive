        ...
        <div id="page-wrapper">
			...
			<ul class="nav nav-pills">
			  ...
			  <li><a href="previous_pores.php">Pore Activity</a></li>
  			  ...
  			  <?php if ($_SESSION['focusreference'] != "NOREFERENCE") {?><li><a href="previous_coverage.php">Coverage Detail</a></li><?php };?>			</ul>
    			 	...
    			 	$('#runsummary').load('includes/runsummary.php');
					        ...
					        $(document).ready(function() {
					            var options = {
									                ...
									                point: {
									                    events: {
									                        click: function () {
									                            ...
									                            var sequrl = "includes/fetchreads.php?type=histogram&job="+this.series.name+"&prev=1&length="+this.category;
									                            window.open(sequrl);
								    ...
								    $.getJSON("jsonencode/histograms.php?prev=1&callback=?", function(json) {
					        ...
					        $(document).ready(function() {
					            var options = {
								    ...
								    $.getJSON("jsonencode/histogrambases.php?prev=1&callback=?", function(json) {
					                options.xAxis.categories = json[0]['data'];
					                options.series[0] = json[1];
					                options.series[1] = json[2];
					                options.series[2] = json[3];
