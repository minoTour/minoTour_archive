			...
			<script>
				...
				parts = pathname.split("/");
							...
							//alert(filename);
							if (filename == "previous_runs.php" || filename  == "previous_summary.php" || filename== "previous_export.php" || filename== "previous_rates.php" || filename== "previous_pores.php" || filename== "previous_quality.php" || filename== "previous_coverage.php" || filename=="reads_table.php" || filename=="manage_data.php"){
								var d = document.getElementById("prevruns");
								d.className = d.className + " active";
							}
							if (filename == "switch_run.php" || filename == "live_reads_table.php" || filename == "live_data.php" || filename  == "current_summary.php" || filename== "export.php" || filename== "set_alerts.php" || filename== "current_export.php" || filename== "current_histogram.php" || filename== "current_rates.php" || filename== "current_pores.php" || filename== "current_quality.php" || filename== "current_coverage.php") {
