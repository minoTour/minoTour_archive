...
if ($login->isUserLoggedIn() == true) {
	...
	*/
	$aColumns = array( 'runindex', 'date','user_name','flowcellid', 'runname', 'activeflag' , 'comment', 'FlowCellOwner','RunNumber', 'reference','reflength' , 'basecalleralg','version' );
  
	// Indexed column (used for fast and accurate table cardinality)
	$sIndexColumn = 'runindex';
