    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
         ...
         <div id="page-wrapper">
             ...
             <div class="row">
                 <div class="col-lg-12">
                     <h1 class="page-header">Reads Summary - run: <?php echo cleanname($_SESSION['focusrun']);; ?></h1>
                                                       <!-- /.col-lg-12 -->
                 <div class="row">
					 <div class="col-lg-12">
			...
			$('#example tbody').on('click', 'tr', function () {
					...
					$.post( "views/live_read_details.php?prev=1", { readname: name })
					  .done(function( data ) {
					    ...
					    if 	(ttrue == 'Y') {
					    	if ($('#toggle-two').prop('checked') == true) {
								$.getJSON('jsonencode/squiggles3.php?prev=1&readname='+name+'&type=template&callback=?', function(data){
									newdata.series = data;
									var chart = new Highcharts.Chart(newdata);
								});
					    	}else{
					    		$.getJSON('jsonencode/squiggles2.php?prev=1&readname='+name+'&type=template&callback=?', function(data){
									newdata.series = data;
									var chart = new Highcharts.Chart(newdata);
								});
					    	}		
