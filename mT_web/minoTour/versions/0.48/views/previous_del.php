...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Previous Variants - run: <?php echo cleanname($_SESSION['focusrun']);; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
			...
			<ul class="nav nav-pills">
			  <li><a href="previous_variants.php">Consensus Variants</a></li>
			  <li><a href="previous_var.php">Variants</a></li>
			  <li class="active"><a href="previous_deletions.php">Deletions</a></li>
   ...
   <select class="form-control" name="type" id="type" onchange="this.form.submit()">
     ...
     <select class="form-control" name="coverage" id="coverage" onchange="this.form.submit()">
     	...
     	<option <?php if ($coverage == 100){echo "selected=\"selected\"";};?> value="100">100</option>
						...
						<div class="row">
					 <div class="col-lg-12">
					 <div id = "consensus_details"><br><h5>Click on a position from the table below to view specific variants.</h5><h5>To download all variants with these parameters <a href="includes/export_variants.php?prev=1&type=<?php echo $type;?>&coverage=<?php echo $coverage;?>&job=deletions" type="button" class="btn btn-primary btn-xs">Download</a></h5>
</div>
	...
	<script>
		$(document).ready(function() {
		    $('#example').dataTable( {
		        ...
		        "processing": true,
		        "serverSide": true,
		        "sAjaxSource": "data_tables/data_table_deletions.php?prev=1&type=<?php echo $type;?>&coverage=<?php echo $coverage;?>"
		    } );
