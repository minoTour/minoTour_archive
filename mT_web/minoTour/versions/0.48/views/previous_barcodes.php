    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
						<?php include 'includes/run_check.php';?>
						            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Previous Barcoding Summary - run: <?php echo cleanname($_SESSION['focusrun']); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
  ...
  <div class="modal-dialog">
	...
	<?php $arr = array("template", "complement", "2d");?>
		...
		$(document).ready(function() {
		    ...
		    $.getJSON('jsonencode/barcodwimm.php?prev=1&type=<?php echo $value; ?>&callback=?', function(data) {
				//alert("success");
...
<script>
                            ...
                            $(document).ready(function() {
                                ...
                                $.getJSON('jsonencode/barcodingcov.php?prev=1&callback=?', function(data) {
					                //alert("success");
...
$(document).ready(function() {
            ...
            pie: {
			    ...
			    $.getJSON('jsonencode/barcodingpie.php?prev=1&callback=?', function(data) {
					                //alert("success");
