...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Current Basecalling Summary - run: <?php echo cleanname($_SESSION['active_run_name']);; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <ul class="nav nav-pills">
              ...
              <li class="active"><a href="current_basecalling.php">Basecaller Summary</a></li>
              <?php }; ?>
...
$(document).ready(function() {
    ...
    $.getJSON('jsonencode/meanparamtime.php?prev=0&timewin=1minwin&param=shiftT&param2=shiftC&callback=?', function(data) {
        //alert("success");
...
$(document).ready(function() {
    ...
    $.getJSON('jsonencode/meanparamtime.php?prev=0&timewin=1minwin&param=scaleT&param2=scaleC&callback=?', function(data) {
        //alert("success");
        options.series = data; // <- just assign the data to the series property.
	...
	<script>
		$(document).ready(function() {
		    ...
		    $.getJSON('jsonencode/meanqualtime.php?prev=0&callback=?', function(data) {
				//alert("success");
		        options.series = data; // <- just assign the data to the series property.
            ...
            <script>
            		$(document).ready(function() {
            		    var options = {
               			...
               			$.getJSON('jsonencode/meanparamtime.php?prev=0&timewin=1minwin&param=abasic_peak&param2=hairpin_peak&callback=?', function(data) {
			...
			$(document).ready(function() {
			    ...
			    $.getJSON('jsonencode/meanparamtime.php?prev=0&timewin=1minwin&param=median_level_temp&param2=median_level_comp&callback=?', function(data) {
				//alert("success");
		        options.series = data; // <- just assign the data to the series property.
...
<script>
			...
			$(document).ready(function() {
			    ...
			    $.getJSON('jsonencode/meanparamtime.php?prev=0&timewin=1minwin&param=num_skipsT&param2=num_skipsC&callback=?', function(data) {
				//alert("success");
		        options.series = data; // <- just assign the data to the series property.
...
$(document).ready(function() {
    ...
    $.getJSON('jsonencode/meanparamtime.php?prev=0&timewin=1minwin&param=num_staysT&param2=num_staysC&callback=?', function(data) {
		//alert("success");
        options.series = data; // <- just assign the data to the series property.
