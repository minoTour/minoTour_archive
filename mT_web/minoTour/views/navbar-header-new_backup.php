      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown messages-menu">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="label label-success">
                ...
                if ($active_runs === false) {
                    echo $_SESSION['active_run_count'];
                }else {
                    echo $active_runs;
                }
                ?>
          ...
          <ul class="dropdown-menu">
            <li class="header">You have <?php echo $_SESSION['active_run_count'];?> live runs</li>
            <li>
            ...
            <li>
              ...
              <ul class="menu">
                <li><!-- start notification -->
                  <a href="#">
                    <i class="fa fa-users text-aqua"></i> 50 new members joined today
                  </a>
                </li><!-- end notification -->
              </ul>
            </li>
        ...
        <li class="dropdown user user-menu">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <img src="images/minotaurlogo.png" class="user-image" alt="User Image">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              <img src="images/minotaurlogo.png" class="img-circle" alt="User Image">
              <p>
