    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            minoTour Tutorials
            <small> - a few quick guides for how to use minoTour.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-question-circle"></i> Tutorials</a></li>
        ...
        <section class="content"><?php include 'includes/run_check.php';?>
            ...
            <div class="box-header">
              <h3 class="box-title">minUP Tutorial</h3>
            </div><!-- /.box-header -->
            <div class="box-body">



            <p>This short video gives you a quick walkthrough illustrating how to upload data using minUP on windows to minoTour.
              <br><br>    <div class="embed-responsive embed-responsive-4by3">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/9cvSfAR7zks" frameborder="0" allowfullscreen></iframe>
              </div>
          </div>
      </div>
        </section><!-- /.content -->
