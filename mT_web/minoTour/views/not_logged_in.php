...
<body>
    ...
    <div class="container">
		<div class="row">
		   							 <h4 class="text-center" style="color:white"><i class="fa fa-bolt"></i> minoTour - <em>real time data analysis for minION data - dev testing</em> - minoTour <i class="fa fa-bolt"></i></h4>
