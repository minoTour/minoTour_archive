        ...
        <section class="content"><?php include 'includes/run_check.php';?>
            ...
            <div class="box-body">
                <?php  if (checkminup($_SESSION['user_name']) > 0){
                    ...
                    echo "<h4><u>minUP for Windows 0.70</u></h4>";
                    echo "<p>The latest version of minUP for Windows can be downloaded below. Please note that you must download either a windows 7 or a windows 10 version now. We are trying to rectify this asap. This compressed folder includes a compiled version of the last and BWA aligners which in turn require CYGWIN to be installed on your system (available from <a href='http://www.cygwin.com/' target='_blank'>www.cygwin.com</a>).<br><br> This version also allows you to use BWA and additinal alignment options will be introduced in the near future.<br><br> A new feature for minUP version 0.6 is a GUI - a graphical user interface - to simplify data upload.<br><br> minUP 0.70 also enables remote control facilities for your minION although this is somewhat experimental! <br><br>";
