...
if ($login->isUserLoggedIn() == true) {
	...
	*/
	...
	FROM ".$sTable ." inner join ". $sTable2. " using (" . $sIndexColumn . ") left join " . $sTable3 . " using (". $sIndexColumn . ") left join " . $sTable4 . " using (" . $sIndexColumn . ") left join " . $sTable5 . " using (" . $sIndexColumn . ") ".$sWhere.$sOrder.$sLimit;
 	//echo $sQuery . "\n\n";
