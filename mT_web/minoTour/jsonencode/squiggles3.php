...
if ($login->isUserLoggedIn() == true) {
    ...
    //Squiggles3 allows the user to flip between a view where the graph is ordered in time, to a view where the graph is ordered by events only.
	...
	if (!$mindb_connection->connect_errno) {
		...
		if (isset($_GET["readname"])) {
			...
			//create arrays to store probability values based on position
			$pAarray;
			$pTarray;
			$pCarray;
			$pGarray;
			
			//create an array to store quiggle heights for a particular position
			$squigglearray;
			...
			foreach ($resultarray as $type => $value) {
				...
				foreach ($value as $start => $value2) {
					...
					if ($firstcheck == 0) {
						...
						for ($i = 0; $i <= 2; $i++) {
							...
							if ($letarray[$i] == "A") {
								$basearray[$position_indicator]["A"]=1;
							}else{
								$basearray[$position_indicator]["A"]=0;
							}
							if ($letarray[$i] == "T") {
								$basearray[$position_indicator]["T"]=1;
							}else{
								$basearray[$position_indicator]["T"]=0;
							}
							if ($letarray[$i] == "G") {
								$basearray[$position_indicator]["G"]=1;
							}else{
								$basearray[$position_indicator]["G"]=0;
							}
							if ($letarray[$i] == "C") {
								$basearray[$position_indicator]["C"]=1;
							}else{
							...
							//if ($i == 2) {
								...
								$pGarray[$position_indicator]=$value2['p_G'];
								$squigglearray[$position_indicator]=$value2['mean'];
							//}
				...
				$firstcheck=0;
				//echo "Squiggle Data\n";
				foreach ($squigglearray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $squigglearray[$sausage]. "],\n";	
//					}
				}	
				echo "]},\n";
...
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $qualityarray[$sausage]. "],\n";	
//					}
				}			
				...
				echo "\"step\": \"center\",\n";
				echo "\"data\":[";
				foreach ($pAarray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $pAarray[$sausage]. "],\n";	
//					}
				}
				//echo "\"dataGrouping\": {
                //    \"units\": \"groupingUnits\"
				...
				echo "\"step\": \"center\",\n";
				echo "\"data\":[";
				foreach ($pTarray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $pTarray[$sausage]. "],\n";	
//					}
				}
				echo "]},\n";
				echo "{\"type\": \"line\",\n";
				...
				echo "\"step\": \"center\",\n";
				echo "\"data\":[";
				foreach ($pGarray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $pGarray[$sausage]. "],\n";	
//					}
				}
				echo "]},\n";
				echo "{\"type\": \"line\",\n";
				...
				echo "\"step\": \"center\",\n";
				echo "\"data\":[";
				foreach ($pCarray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $pCarray[$sausage]. "],\n";	
//					}
				}
				echo "]},\n";
				}
...
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $basearray[$sausage]['A']. "],\n";	
//					}
				}
				echo "]},\n";
				echo "{\"type\": \"column\",\n";
				...
				foreach ($basearray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $basearray[$sausage]['T']. "],\n";	
//					}
				}
				echo "]},\n";
				echo "{\"type\": \"column\",\n";
				...
				foreach ($basearray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $basearray[$sausage]['G']. "],\n";	
//					}
				}
				echo "]},\n";
				echo "{\"type\": \"column\",\n";
				...
				foreach ($basearray as $sausage => $monkey) {
//					foreach ($value2 as $value2=> $monkey) {
						echo "[" . ($sausage) ."," . $basearray[$sausage]['C']. "],\n";	
//					}
				}
				echo "]},\n";
			echo "]);";
