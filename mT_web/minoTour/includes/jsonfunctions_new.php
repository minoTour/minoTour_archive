...
function meanparamtime($jobname,$currun,$param,$param2,$timewin) {
    ...
    if ($checkingrunning === "No" || $checkingrunning === FALSE){
		...
		if (is_object($checking) && $checking->num_rows ==1){
            ...
            $sqlmeanparams = "select exp_start_time,".$timewin.",AVG(".$param.") as param,AVG(".$param2.") as param2 from basecall_summary group by ".$timewin.";";
            $sqlmeanparamspass = "select exp_start_time,".$timewin.",AVG(".$param.") as param,AVG(".$param2.") as param2 from basecall_summary where pass = 1 group by ".$timewin.";";
            $sqlmeanparamsfail = "select exp_start_time,".$timewin.",AVG(".$param.")as param,AVG(".$param2.") as param2 from basecall_summary where pass = 0 group by ".$timewin.";";
