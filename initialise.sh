...
sed -i '/directory=\/path\/to\/your\/minotour\/web\/install\//c\directory='${webpath} mT_param.test
sed -i '/dbuser=\*db_user_name\*/c\dbuser='${webaccountname} mT_param.test
sed -i '/dbpass=\*db_password\*/c\dbpass='${webpass1} mT_param.test
